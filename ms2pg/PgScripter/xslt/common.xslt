...
>
  ...
  <xsl:template match="DataType">
    ...
    <xsl:choose >
      ...
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='IMAGE'">BIGINT</xsl:when>
      ...
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='CHAR'">TEXT</xsl:when>
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='NCHAR'">TEXT</xsl:when>
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='VARCHAR'">TEXT</xsl:when>
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='NVARCHAR'">TEXT</xsl:when>
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='NTEXT'">TEXT</xsl:when>
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='FLOAT'">DOUBLE PRECISION</xsl:when>
      ...
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='INTEGER'">INT</xsl:when>
      ...
      <xsl:when test="translate($datatype, $lowercase, $uppercase)='DEC'">DECIMAL</xsl:when>
